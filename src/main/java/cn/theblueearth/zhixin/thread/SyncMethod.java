...
public class SyncMethod {
	public synchronized void syncMethod2() {
        try {
            System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@ (syncMethod2, 已经获取内置锁`SyncMethod.this`)，倒计时："+System.currentTimeMillis());
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@ (syncMethod2, 即将释放内置锁`SyncMethod.this`)，倒计时："+System.currentTimeMillis());
    }

    public synchronized void syncMethod1() {
        System.out.println("######################## (syncMethod1, 已经获取内置锁`SyncMethod.this`, 并即将退出)，倒计时："+System.currentTimeMillis());
    }
    ...
    static class Thread2 extends Thread {
        ...
        public void run() {
        	//神奇之处：对象锁
        	//System.out.println("Thread2 running ...，倒计时："+System.currentTimeMillis());
