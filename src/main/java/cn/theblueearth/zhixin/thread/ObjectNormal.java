...
public class ObjectNormal {
	...
	public static void main(String[] args) {
		ObjectNormal objectSynchronized = new ObjectNormal();
		Object printObjectA = new Object();
		Object printObjectB = new Object();
		System.out.println("Print Start0..."+Thread.currentThread());
		objectSynchronized.new PrintA(printObjectA,printObjectB).run();
		System.out.println("Print Start1..."+Thread.currentThread());
		objectSynchronized.new PrintB(printObjectA,printObjectB).run();
